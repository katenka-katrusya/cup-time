            ...
            {Object.entries(categories).map(([key, value]) =>
              <li key={key} className='footer__menu-item'>
                <Link to={`/products?category=${key}`}
                      className={`footer__menu-link menu-link ${getActiveClass(key)}`}
        ...
        <div className='footer__info'>
          ...
          <ul className='footer__developers'>
            <li className='footer__developer'>Designer:
              <a href='https://t.me/Mrshmallowww' className='footer__developer-link' target='_blank'> Anastasia
                Ilina</a>
            </li>
        ...
        <div className='footer__contacts'>
          ...
          <ul className='footer__social'>
            <li className='footer__social-item'>
              <a href='#' target='_blank' className='footer__social-link' aria-label='Канал в Телеграм'>
                <svg className='footer__social-img' width='32' height='32' viewBox='0 0 32 32'
            ...
            <li className='footer__social-item'>
              <a href='#' target='_blank' className='footer__social-link' aria-label='Канал на Youtube'>
                <svg className='footer__social-img' width='32' height='32' viewBox='0 0 32 32'
                     fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
            ...
            <li className='footer__social-item'>
              <a href='#' target='_blank' className='footer__social-link' aria-label='Группа вконтакте'>
                <svg className='footer__social-img' width='32' height='32' viewBox='0 0 32 32'
                     fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
